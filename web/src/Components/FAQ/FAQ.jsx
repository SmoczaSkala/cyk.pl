  ...
  return (
    <div className="FAQ">
      ...
      <div className="box">
        ...
        <hr />
        <p>
          Tak, nasz wirtualny psycholog jest dostępny online przez całą dobę, 7
          dni w tygodniu, aby zapewnić wsparcie i pomoc w każdej chwili, gdy go
          potrzebujesz.
        </p>
      </div>
      <div className="box">
        <span>Jakie rodzaje porad psychologicznych oferuje wasza strona?</span>
        <hr />
        <p>
          Nasza strona oferuje szeroki zakres porad psychologicznych,
          obejmujących tematy takie jak radzenie sobie ze stresem, zarządzanie
          emocjami, radzenie sobie z trudnościami w relacjach, kwestie zdrowia
          psychicznego i wiele innych.
        </p>
      </div>
      <div className="box">
        <span>
      ...
      <div className="box">
        ...
        <hr />
        <p>
          Tak, rozmowy z naszym wirtualnym psychologiem są poufne i bezpieczne.
          Dbamy o zachowanie prywatności i bezpieczeństwo danych naszych
          użytkowników.
        </p>
      </div>
      <div className="box">
        <span>Jak mogę skorzystać z usług waszej poradni psychologicznej?</span>
        <hr />
        <p>
          Aby skorzystać z usług naszej poradni psychologicznej, wystarczy
          zalogować się na naszą stronę i skorzystać z wirtualnego psychologa
          AI.
        </p>
      </div>
    </div>
